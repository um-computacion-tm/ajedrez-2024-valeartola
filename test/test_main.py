...
class TestMain(unittest.TestCase):
    @patch(  # este patch controla lo que hace el input
        'builtins.input',
        side_effect=["no",'1', '1', '2', '2'], # estos son los valores que simula lo que ingresaria el usuario
    )
    ...
    @patch(  # este patch controla lo que hace el input
        'builtins.input',
        side_effect=["no",'hola', '1', '2', '2'], # estos son los valores que simula lo que ingresaria el usuario
    )
    @patch('builtins.print') # este patch controla lo que hace el print
    @patch.object(Chess, 'move')
    ...
    @patch(  # este patch controla lo que hace el input
        'builtins.input',
        side_effect=["no",'1', '1', '2', 'hola'], # estos son los valores que simula lo que ingresaria el usuario
    )
    @patch('builtins.print') # este patch controla lo que hace el print
    @patch.object(Chess, 'move')
    ...
    @patch(  # este patch controla lo que hace el input
        'builtins.input',
        side_effect=['si', 'si'], # estos son los valores que simula lo que ingresaria el usuario
    )
    @patch('builtins.print') # este patch controla lo que hace el print
    @patch.object(
        Chess,
